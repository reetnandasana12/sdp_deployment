    ...
    return (
        <div className=" rounded-lg p-4 flex space-x-3">
            ...
            <div className="flex flex-col space-y-3 flex-grow">
                <h5 className="text-base poppins text-gray-700">{props.email}</h5>
                <h1 className="font-semibold text-lg text-primary poppins">${props.name}</h1>
                <p className="text-sm poppins text-gray-400">{props.phone}</p>
            </div>

            <div className="flex items-center px-4 py-2 space-x-3">
                <span className="text-lg text-gray-700 poppins select-none">{props.status} items</span>
            </div>
           {/*  quantity 
            <div className="flex items-center px-4 py-2 space-x-3">
                <AiOutlineMinus
